...
public class ForwardTest2 extends HttpServlet {
        ...
        throws IOException, ServletException
    {
		...
		out.println("<a href='/examples/sources/ForwardTest2.java'><b><font color='#FFFFFF'><b>view source </b></font></a></td>");
		out.println("<td  width=\"25%\" align=\"center\" onMouseover=\"this.style.backgroundColor='#0099cc'\" onMouseout=\"this.style.backgroundColor='#999999'\">");
		out.println("</td>");
		out.println("<td  width=\"25%\" align=\"center\" onMouseover=\"this.style.backgroundColor='#0099cc'\" onMouseout=\"this.style.backgroundColor='#999999'\">");
		out.println("</td>");
        ...
        out.println("<br><h3>Forward using NamedDispatcher</h3>");
        out.println("<b>This table is generated by ForwardTest2</b><br>");
	...
	request.setAttribute("original servlet", "ForwardTest2");
	request.setAttribute("forwarded servlet", "ForwardedPage");
        ...
        RequestDispatcher rd = this.getServletContext().getNamedDispatcher("ForwardedPage");
