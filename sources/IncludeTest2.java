...
public class IncludeTest2 extends HttpServlet {
        ...
        throws IOException, ServletException
    {
		...
		out.println("<a href='/examples/sources/IncludeTest2.java'><b><font color='#FFFFFF'><b>view source </b></font></a></td>");
		out.println("<td  width=\"25%\" align=\"center\" onMouseover=\"this.style.backgroundColor='#0099cc'\" onMouseout=\"this.style.backgroundColor='#999999'\">");
		out.println("</td>");
		out.println("<td  width=\"25%\" align=\"center\" onMouseover=\"this.style.backgroundColor='#0099cc'\" onMouseout=\"this.style.backgroundColor='#999999'\">");
		out.println("</td>");
        ...
        out.println("<br><h3>Include using NamedDispatcher</h3>");
        out.println("<b>This table is generated by IncludeTest2</b><br>");
